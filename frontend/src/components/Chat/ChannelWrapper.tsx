...
export default function ChannelWrapper(): JSX.Element {
  ...
  const {currentTownID, currentTownFriendlyName, players, userName, myPlayerID, apiClient, chatClient } = useCoveyAppState();
  ...
  }, [chatClient, currentTownFriendlyName]);
